/*************************************************************************************************
                                      PROGRAMMINFO
**************************************************************************************************
Funktion: Toni MP3-Player mit RFID-Kennung, SD-Card und Accses-Point WEB-Server

**************************************************************************************************
Version: 12.04.2023
**************************************************************************************************
Board: ESP32 Dec Module (ESP32vn IoT UNO) V1.0.6
**************************************************************************************************
Libraries:
...
GPIO2 -> Yellow (lights if WIFI enabled, blinks on WIFI activity)
GPIO17 -> Green (lights while playing, blinks while idle)
GPIO16 -> Red (indicates error states, low battery)

Power:
GPIO36 -> Connected to battery voltage for sensing battery state. Be sure to limit the voltage range, e.g. using a voltage divider. 
You may also have to adjust the margins in config.h. If you want to skip this, connect to 3.3v.
